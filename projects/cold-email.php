            ...
            <div class="container">
                <div class="row mt-5 pt-5 mb-5">
                    <div class="col-lg-12">
                        ...
                        <h1 class="display-4 mb-3 wow animate__animated animate__fadeInUp">Cold Email Automation</h1>
                ...
                <div class="row g-5">
                    <div class="col-lg-7">
                        ...
                        <div class="project-description wow animate__animated animate__fadeInUp">
                            ...
                            <p>This workflow automates <strong>personalized cold email outreach</strong>, pulling contact data from Airtable, validating email reputation, generating AI-crafted messages, and sending them via Gmail.</p>
                            ...
                            <ul class="list-unstyled">
                                <li class="mb-3 d-flex align-items-start gap-3">
                                    ...
                                    <div>
                                        <strong>Email Reputation Check:</strong> Validates email reputation and ensures deliverability.
                                    </div>
                                </li>
                                <li class="mb-3 d-flex align-items-start gap-3">
                                    <i class="fa-solid fa-check text-primary mt-1"></i>
                                    <div>
                                        <strong>AI-Crafted Messages:</strong> Generates personalized messages using AI.
                                    </div>
                                </li>
                                <li class="mb-3 d-flex align-items-start gap-3">
                                    <i class="fa-solid fa-check text-primary mt-1"></i>
                                    <div>
                                        <strong>Saves Record:</strong> 
                                        Saves the record in Airtable with the email status and message.
                                    </div>
                                </li>
                            </ul>
                        </div>
                        ...
                        <div class="glass-card p-4 wow animate__animated animate__fadeInRight">
                            ...
                            <div class="mb-4">
                                ...
                                <div class="d-flex flex-wrap gap-2">
                                    ...
                                    <span class="skill-pill m-0">EmailRepuation API</span>
                                </div>
                            </div>
