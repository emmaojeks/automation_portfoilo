            ...
            <div class="container">
                <div class="row mt-5 pt-5 mb-5">
                    <div class="col-lg-12">
                        ...
                        <h1 class="display-4 mb-3 wow animate__animated animate__fadeInUp">LinkedIn Search Automation</h1>
                ...
                <div class="row g-5">
                    <div class="col-lg-7">
                        <div class="project-showcase mb-5 wow animate__animated animate__fadeInLeft">
                            <img src="<?= WEB_ROOT ?>assets/img/automation/linkedin-scraper.png" class="img-fluid rounded-4 shadow-lg border border-secondary" alt="LinkedIn Search Automation Interface">
                            <img src="<?= WEB_ROOT ?>assets/img/automation/linkedin-scraper-proof.png" class="img-fluid mt-3 rounded-4 shadow-lg border border-secondary" alt="LinkedIn Search Automation Interface">
                        </div>

                        <div class="project-description wow animate__animated animate__fadeInUp">
                            <h3 class="mb-4">Overview</h3>
                            <p>This automation tool helps businesses and recruiters efficiently gather data from LinkedIn. By automating the search process, it saves hours of manual work and ensures consistent data collection.</p>
                            ...
                            <ul class="list-unstyled">
                                <li class="mb-3 d-flex align-items-start gap-3">
                                    ...
                                    <div>
                                        <strong>Automated Searching:</strong> Runs searches based on your criteria without manual intervention.
                                    </div>
                                </li>
                                <li class="mb-3 d-flex align-items-start gap-3">
                                    <i class="fa-solid fa-check text-primary mt-1"></i>
                                    <div>
                                        <strong>Data Extraction:</strong> Extracts key profile details such as name, title, company, and location.
                                    </div>
                                </li>
                                <li class="mb-3 d-flex align-items-start gap-3">
                                    <i class="fa-solid fa-check text-primary mt-1"></i>
                                    <div>
                                        <strong>Export Capabilities:</strong> Exports results to CSV or connects directly to your CRM.
                                    </div>
                                </li>
                            </ul>
                        </div>
                        ...
                        <div class="glass-card p-4 wow animate__animated animate__fadeInRight">
                            ...
                            <div class="mb-4">
                                ...
                                <div class="d-flex flex-wrap gap-2">
                                    ...
                                    <span class="skill-pill m-0">Google Search API</span>
                                </div>
                            </div>
