...
<head>
    ...
    <title>LinkedIn Search Automation - <?php echo $websitetitle; ?></title>
            ...
            <div class="container">
                <div class="row mt-5 pt-5 mb-5">
                    <div class="col-lg-12">
                        ...
                        <h1 class="display-4 mb-3 wow animate__animated animate__fadeInUp">Company Technology Stack Extraction Automation</h1>
                        <p class="lead text-white wow animate__animated animate__fadeInUp" data-wow-delay="0.1s">
                            A powerful tool to streamline your LinkedIn prospecting and lead generation.
                        </p>
                    </div>
                </div>
                ...
                <div class="row g-5">
                    <div class="col-lg-7">
                        <div class="project-showcase mb-5 wow animate__animated animate__fadeInLeft">
                            <img src="<?= WEB_ROOT ?>assets/img/automation/web-tech-scanner.png" class="img-fluid rounded-4 shadow-lg border border-secondary" alt="Website Tech Scanner Interface">
                        </div>

                        <div class="project-description wow animate__animated animate__fadeInUp">
                            <h3 class="mb-4">Overview</h3>
                            <p>This workflow automatically discovers and documents the technologies a company uses such as hosting providers, CMS, and analytics tools directly from a list of company domains in Google Sheets.</p>
                            ...
                            <ul class="list-unstyled">
                                <li class="mb-3 d-flex align-items-start gap-3">
                                    ...
                                    <div>
                                        <strong>Get Company Domains:</strong> Reads company domains (e.g., example.com) from a connected Google Sheet.
                                    </div>
                                </li>
                                <li class="mb-3 d-flex align-items-start gap-3">
                                    <i class="fa-solid fa-check text-primary mt-1"></i>
                                    <div>
                                        <strong>HTTP Request (via Jina AI / BuiltWith):</strong> Sends an API request to https://r.jina.ai/builtwith.com/&lt;company-domain&gt; for each domain. Retrieves detailed data about the website's detected technologies.
                                    </div>
                                </li>
                                <li class="mb-3 d-flex align-items-start gap-3">
                                    <i class="fa-solid fa-check text-primary mt-1"></i>
                                    <div>
                                        <strong>AI Analysis – LLM Chain AI model:</strong> analyzes the raw BuiltWith data and extracts relevant technologies, grouping them into categories: Hosting Providers, CMS, Analytics Tools, etc.
                                    </div>
                                </li>
                            </ul>
                        </div>
                        ...
                        <div class="glass-card p-4 wow animate__animated animate__fadeInRight">
                            ...
                            <div class="mb-4">
                                ...
                                <div class="d-flex flex-wrap gap-2">
                                    ...
                                    <span class="skill-pill m-0">Jina API</span>
                                </div>
                            </div>
